        ...
        <section class="col-lg-8">
            ...
            <form method="post" action="{{ route('user.dathang') }}" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('thanhpho') is-invalid @enderror" type="text" id="thanhpho" name="thanhpho" required />
                    @error('thanhpho')
                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('quanhuyen') is-invalid @enderror" type="text" id="quanhuyen" name="quanhuyen" required />
                    @error('quanhuyen')
                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('phuongxa') is-invalid @enderror" type="text" id="phuongxa" name="phuongxa" required />
                    @error('phuongxa')
                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
                <div class="mb-3">
                    <label class="form-label" for="tenduong">Tên đường</label>
                    <input class="form-control @error('tenduong') is-invalid @enderror" type="text" id="tenduong" name="tenduong" required />
                    @error('tenduong')
                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('ghichu') is-invalid @enderror" id="ghichu" name="ghichu" rows="3"></textarea>
                    @error('ghichu')
                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
