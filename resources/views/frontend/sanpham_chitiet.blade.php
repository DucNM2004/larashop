                ...
                <div class="col-lg-7 pe-lg-0 pt-lg-4">
                    ...
                    <div class="product-gallery">
                        <div class="product-gallery-preview order-sm-2">
                            ...
                            <p>Phân loại: {{ $sanPham->loaiSanPham->tenloai }}</p>
                            <div class="product-gallery-preview-item active" id="first">
                                <img class="image-zoom" src="{{ env('APP_URL') . '/storage/app/private/' . $sanPham->hinhanh }}" data-zoom="{{ env('APP_URL') . '/storage/app/private/' . $sanPham->hinhanh }}" width="300" />
