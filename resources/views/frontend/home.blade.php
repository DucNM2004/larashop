        ...
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="px-4 pe-sm-0 ps-sm-5">
                    ...
                    <h3 class="mt-4 mb-1 text-body fw-light">Gói cước hot, tốc độ cao!</h3>
                    <h2 class="mb-1">Internet siêu tốc - Giảm giá đến 50%!</h2>
                    <p class="h5 text-body fw-light">Số lượng có hạn - Nhanh tay sở hữu ngay hôm nay!</p>
